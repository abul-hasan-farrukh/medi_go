...
function ContactUs() {
    ...
    const submitForm = async (e) => {
        ...
        // Test Case: Leaving any column → Alert box
        ...
        // Test Case: Phone must be exactly 10 digits
        ...
        try {
            ...
            // Test Case: Correct details → Confirm Alert box
            if (serverResponse.data === "Contact added successfully") {
                Swal.fire({
                    title: "Success",
            ...
            <div>
                ...
                <section className="bg-primary bg-gradient text-white text-center py-5">
                    <div className="container">
                        ...
                        <p className="lead">
                            Get in touch with MediGo for any queries, support, or assistance.
                        </p>
                    </div>
                </section>
                        ...
                        <div className="row g-0">
                            ...
                            <div className="col-md-7 p-4">
                                ...
                                <form onSubmit={submitForm} className={`needs-validation ${validate ? 'was-validated' : ''}`} noValidate>
                                    ...
                                    <label htmlFor="email" className="form-label mt-2">Phone No</label>
                                    <input
                                        type="text"
                                        name="phone"
                                        value={data.phone}
                                    ...
                                    <label htmlFor="email" className="form-label mt-2">Message</label>
                                    <textarea
                                        rows="4"
                                        name="question"
                                        value={data.question}
